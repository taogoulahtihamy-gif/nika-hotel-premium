...
import { menuItems, hotel } from '@/data/site';
...
export default function RestaurantSection() {
  ...
  return (
    <section className="section" id="restaurant">
      <div className="section-inner">
        <div className="sectionTitle">
          <h2>Restaurant<br/>& Cuisine</h2>
        ...
        >
          ...
          <div>
            ...
            <a className="btn btn-primary" href={wa} target="_blank" rel="noopener noreferrer" style={{ marginTop: 24 }}>
