  ...
  return (
    <section className="hero" id="hero">
      ...
      <div className="heroGrid">
        ...
        >
          <div className="eyebrow">Bujumbura &bull; Kamenge &bull; Premium Stay</div>
          <h1>NIKA<br/>HOTEL</h1>
          <p>
            Votre expérience premium à Bujumbura. Hébergement, restaurant et bar lounge
            dans un cadre moderne et raffiné.
          </p>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.3, ease: [0.68, -0.55, 0.265, 1.55] as const }}
        >
          ...
          <div className="heroActions">
            <a className="btn btn-primary" href={wa} target="_blank" rel="noopener noreferrer" style={{ flex: 1, justifyContent: 'center' }}>
            ...
            <a className="btn btn-outline" href={`tel:${hotel.phone1}`} style={{ flex: 1, justifyContent: 'center' }}>
