    ...
    <nav className={`nav${scrolled ? ' scrolled' : ''}${menuOpen ? ' menu-open' : ''}`}>
      ...
      <ul className={`navlinks${menuOpen ? ' active' : ''}`}>
        ...
        <li className="nav-mobile-btn">
          <a className="btn btn-primary" href={wa} target="_blank" rel="noopener noreferrer" style={{ width: '100%', justifyContent: 'center' }}>
      ...
      <div className="nav-actions">
        <Link href="/booking" className="btn-nav nav-desktop-only">Réserver</Link>
        <a className="btn-nav wa-btn nav-desktop-only" href={wa} target="_blank" rel="noopener noreferrer">
